...
```
grep -h "## Version" _anniversary_/Interface/AddOns/{SetupCore,ElvUIFixes,TSMSetup,ZygorSetup,DruidSetup,PaladinSetup,ShamanSetup,WarriorSetup,HunterSetup,MageSetup,PriestSetup,RogueSetup,WarlockSetup}/*.toc
```
